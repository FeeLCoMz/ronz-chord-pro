...
export default function SetlistSongsPage({ setlists, songs }) {
  ...
  return (
    ...
    <>
    <button className="back-btn" onClick={() => navigate('/setlists')}>&larr; Kembali ke daftar setlist</button><div className="section-title">{setlist.name}</div><div className="info-text" style={{ marginTop: -12, marginBottom: 16, fontSize: '1.05em' }}>
